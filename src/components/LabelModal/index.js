...
class LabelModal extends Component {
  ...
  render() {
    return (
      ...
      <div className="info">Please rephrase  "{this.props.issuedQuery}" if you think it can be said better or is incorrect, and press submit. Otherwise, label the original command as correct. </div>
